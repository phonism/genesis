...
@register_cuda("transpose")
def transpose(x, dim0, dim1):
    """
    Transpose two dimensions of tensor.
    """
    return x.transpose(dim0, dim1)


@register_cuda("broadcast_to")
...
@register_cuda("repeat_interleave")
